...
function Projects() {
    ...
    const handleAllProjects = () => {
                let displayProject =
                    [
                        { name: 'RedditClone', about: 'A clone that mimics reddit.', img: RedditClone, github: 'https://github.com/KathyPuma/Reddit_clone', deployed: 'http://reddit-replica1.herokuapp.com/' },
